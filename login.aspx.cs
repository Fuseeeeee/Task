...
namespace project
{
    public partial class login : System.Web.UI.Page
    {
        ...
        {
            Label1.Visible = true;
            string strselect = "select count(id) from project_tab where username='" + TextBox1.Text + "'and [email-id]='" + TextBox2.Text + "'";
            ...
            if (cid == "1")
            {
                string strsel = "select id from project_tab where username='" + TextBox1.Text + "'and [email-id]='" + TextBox2.Text + "'";
